    ...
    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
      {categories.slice(0, 5).map((category) => (
        <button
          ...
          className="group flex flex-col items-center p-6 bg-white rounded-3xl shadow-soft hover:shadow-hover border border-slate-100 transition-all duration-300 hover:-translate-y-1 cursor-pointer text-left w-full"
        >
